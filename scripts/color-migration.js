...
const dynamicPatterns = [
    ...
    { regex: /\bbg-slate-(\d{1,3})\b/g, replace: (_, p1) => p1 === '200' ? 'bg-neutral-background' : `bg-neutral-background/${p1}` },
    { regex: /\bborder-slate-(\d{1,3})\b/g, replace: (_, p1) => p1 === '200' ? 'border-divider' : `border-divider/${p1}` },
];
