...
**Actions Required:**
1. **Read the complete codebase technical guide (`docs/onboarding/codebase-technical-guide.md`)**
...
**📋 TECHNICAL DETAILS:** For detailed technical implementation guidance, configuration options, and troubleshooting, refer to the `docs/onboarding/codebase-technical-guide.md`.
