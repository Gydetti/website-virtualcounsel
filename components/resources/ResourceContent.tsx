  ...
  return (
    <>
      ...
      {resource.sections.map((section, i) => {
        switch (section.type) {
          case "text":
            return <TextSection key={`${section.type}-${i}`} {...section.props} />;
          case "form":
            return <FormSection key={`${section.type}-${i}`} {...section.props} />;
          case "image":
            return <ImageSection key={`${section.type}-${i}`} {...section.props} />;
          default:
            return null;
        }
      })}
