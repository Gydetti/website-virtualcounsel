  ...
  const steps = [
    {
      ...
      description:
        "We start by learning about your business, goals, and challenges to create a tailored strategy.",
      details: [
    ...
    },
    {
      ...
      description:
        "We develop a customized roadmap designed to achieve your specific business objectives.",
      details: [
    ...
    },
    {
      ...
      description:
        "Our team executes the strategy with precision, expertise, and attention to detail.",
      details: [
        "Expert execution",
    ...
    },
    {
      ...
      description:
        "We monitor results and make data-driven adjustments to maximize performance.",
      details: [
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <Badge className="mb-4 bg-blue-100 text-primary hover:bg-blue-200">
            Short label summarizing the process overview
          </Badge>
          <h2 className="section-title">
            Process section heading: concise process overview
          </h2>
          <p className="section-subtitle">
            Brief intro explaining the four-step workflow and its benefits for
            clients.
          </p>
        </div>
