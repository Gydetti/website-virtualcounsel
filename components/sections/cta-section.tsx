...
export default function CtaSection({
	badgeText = "Short label for CTA section",
	heading = "Section heading prompting user action",
	description = "Brief subtitle explaining value proposition and next steps",
	primaryCtaText = "Primary CTA text guiding next step",
	primaryCtaLink = "/contact",
	secondaryCtaText = "Secondary CTA text for more info",
