    ...
    <section id="testimonials" className="section-padding bg-gray-50 relative overflow-hidden">
      ...
      <div className="container-wide relative z-10">
        <div className="text-center mb-16">
          <Badge className="mb-4 bg-blue-100 text-primary hover:bg-blue-200">Testimonials</Badge>
                  ...
                  >
                    <Card className="border-none shadow-lg hover:shadow-xl transition-all bg-white h-full">
                      <CardContent className="p-8">
                        ...
                        <p className="text-lg text-gray-700 italic mb-8 line-clamp-6">"{testimonial.quote}"</p>
