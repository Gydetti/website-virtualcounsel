    ...
    <section id="services" className="section-padding bg-gray-50 relative overflow-hidden">
      ...
      <div className="container-wide relative z-10">
        <div className="text-center mb-16">
          <Badge className="mb-4 bg-blue-100 text-primary hover:bg-blue-200">Our services</Badge>
          <h2 className="section-title">How we can help you grow</h2>
          <p className="section-subtitle">
            We offer specialized services designed to help entrepreneurs and small businesses thrive in the digital landscape.
          </p>
        </div>
            ...
            >
              <Card
                className={`card-equal-height h-full overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 ${
                  service.popular ? "border-primary shadow-lg relative" : "border-gray-200 shadow-sm"
                }`}
              >
                {service.popular && (
                ...
                <CardHeader className={service.popular ? "pt-12" : ""}>
                  <div className="mb-6 bg-primary/10 w-16 h-16 rounded-lg flex items-center justify-center">
                    {iconMap[service.icon] || <Globe className="h-10 w-10 text-primary" />}
                  </div>
                ...
                <CardFooter className="card-footer pt-6">
                  <Button
                    ...
                    asChild
                  >
                    <Link href={`/services/${service.slug}`}>Learn more<ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" /></Link>
                  </Button>
                </CardFooter>
              </Card>
            </motion.div>
        ...
        <div className="text-center mt-12">
          <Button size="lg" className="bg-primary hover:bg-primary/90 group" asChild>
            <Link href="/services">View all services<ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" /></Link>
          </Button>
        </div>
      </div>
    </section>
