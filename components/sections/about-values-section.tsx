...
export default function AboutValuesSection({ badgeText, heading, values }: AboutValuesSectionProps) {
  return (
    <Section id="about-values" className="py-12">
      <LazySection animation="slide-up" delay={0} className="max-w-3xl mx-auto text-center">
