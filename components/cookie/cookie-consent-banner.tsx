                ...
                <Tabs defaultValue="essential" className="w-full">
                  ...
                  <TabsContent value="analytics" className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Switch checked={localConsents.analytics} onCheckedChange={() => handleToggle("analytics")} />
                    </div>
                  </TabsContent>
                  <TabsContent value="marketing" className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Switch checked={localConsents.marketing} onCheckedChange={() => handleToggle("marketing")} />
                    </div>
                  </TabsContent>
                  <TabsContent value="preferences" className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Switch checked={localConsents.preferences} onCheckedChange={() => handleToggle("preferences")} />
                    </div>
                  </TabsContent>
                </Tabs>
