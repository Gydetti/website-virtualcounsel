...
((e) => {
	...
	const o = (e) => (11 === e.nodeType && e.host ? "#s" : e.nodeName);
	const a = () =>
	...
	const j = (e) => new ("detail" in e ? CustomEvent : Event)(e.type, e);
	const P = (e, t, r, n) => {
				...
				n
					...
					: (t.x ||
							...
							((e, t, n) => {
								...
								const c = (r, n) =>
									e.postMessage([10, { V: t, q: r, b: M(t, Array.from(n)) }]);
								if (
									((n._ptf = void 0),
									a.map((e) => {
	...
	const q = (e, r) => (void 0 !== e[r] ? new e[r](t) : 0);
	let G;
	(async (e) => {
		...
		return (n, i) => {
			...
			if (0 === s) {
				const e = (() => {
					...
					const r = E.createComment("");
					const n = E.createDocumentFragment();
					const i = E.createElement("p").attachShadow({ mode: "open" });
					const s = q(S, "IntersectionObserver");
					const o = q(S, "MutationObserver");
					const a = q(S, "ResizeObserver");
