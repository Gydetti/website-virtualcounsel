      ...
      <section className="bg-gradient-to-r from-blue-50 to-white py-16 md:py-24">
        <div className="container-wide">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">How We Help You Grow</h1>
            <p className="text-lg text-gray-700 mb-8">
              We offer specialized services designed to help entrepreneurs and small businesses thrive in the digital
              landscape.
            </p>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                We understand the unique challenges entrepreneurs face in today's digital landscape. Our services are
            ...
            <div className="relative h-[400px] rounded-xl overflow-hidden shadow-xl">
              <Image src="/placeholder.svg?height=600&width=800" alt="Why Choose Us" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container-wide text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Schedule a free consultation to discuss your business needs and how we can help you achieve your goals.
          </p>
