				...
				<Section className="bg-gradient-to-r from-blue-50 to-white">
					<div className="text-center max-w-3xl mx-auto">
						<Badge className="mb-4 bg-blue-100 text-primary hover:bg-blue-200">
							Short label introducing services overview
						</Badge>
						<h1>Main heading summarizing services overview</h1>
						<p className="text-gray-700 mb-8">
							Brief description outlining what this services page covers and its
							value to clients.
						</p>
					</div>
				</Section>
