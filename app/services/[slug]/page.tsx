...
import type { Services } from '@/types/generated/serviceDetailPage.d';
...
export default async function ServicePage({ params }: { params: { slug: string } }) {
  ...
  // Cast slug to key of servicesDetailData
  const serviceDetailData = getServiceDetailData(slug as keyof Services);
  ...
  return (
    <>
      ...
      {/* Problem Section */}
      {'problemSection' in serviceDetailData && serviceDetailData.problemSection && (
      ...
      {'features' in serviceDetailData &&
        serviceDetailData.features &&
        serviceDetailData.features.length > 0 && (
          <Section>
      ...
      {/* Process Section */}
      {'processSteps' in serviceDetailData &&
        serviceDetailData.processSteps &&
        serviceDetailData.processSteps.length > 0 && (
      ...
      {/* CTA Section */}
      {'readyToStartCta' in serviceDetailData && serviceDetailData.readyToStartCta && (
      ...
      {'uniqueValue' in serviceDetailData && serviceDetailData.uniqueValue && (
        <Section>
      ...
      {/* FAQ Section */}
      {'faqSection' in serviceDetailData &&
        serviceDetailData.faqSection &&
        serviceDetailData.faqSection.items && (
          <Section className="bg-neutral-background">
      ...
      {'testimonialsSection' in serviceDetailData &&
        serviceDetailData.testimonialsSection &&
        serviceDetailData.testimonialsSection.testimonials && (
          <Section>
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
