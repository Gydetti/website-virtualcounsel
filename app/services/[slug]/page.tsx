                  ...
                  <div className="md:grid md:grid-cols-2 gap-8 items-center">
                    <div className={`md:text-right ${index % 2 === 1 ? "md:order-2" : ""}`}>
                      <div className="bg-white p-6 rounded-lg shadow-md relative">
                        <div className="absolute top-1/2 transform -translate-y-1/2 hidden md:block right-0 translate-x-1/2 z-10">
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container-wide text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Schedule a free consultation to discuss how we can help you achieve your business goals.
          </p>
