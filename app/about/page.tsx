...
export default function AboutPage() {
  ...
  const values = [
    {
      title: "[VALUE_1_TITLE]",
      description: "[VALUE_1_DESCRIPTION: Explain this core value and why it matters to your business.]",
    },
    {
      title: "[VALUE_2_TITLE]",
      description: "[VALUE_2_DESCRIPTION: Explain this core value and why it matters to your business.]",
    },
    {
      title: "[VALUE_3_TITLE]",
      description: "[VALUE_3_DESCRIPTION: Explain this core value and why it matters to your business.]",
    },
    {
      title: "[VALUE_4_TITLE]",
      description: "[VALUE_4_DESCRIPTION: Explain this core value and why it matters to your business.]",
    },
  ]
  ...
  return (
    <>
      <section className="bg-gradient-to-r from-blue-50 to-white py-16 md:py-24">
        <div className="container-wide">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="mb-4 bg-blue-100 text-primary hover:bg-blue-200">[ABOUT_PAGE_BADGE]</Badge>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">[ABOUT_PAGE_TITLE]</h1>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <div className="font-bold text-primary text-xl">[STAT_1_VALUE]</div>
                  <div className="text-gray-600">[STAT_1_LABEL]</div>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <div className="font-bold text-primary text-xl">[STAT_2_VALUE]</div>
                  <div className="text-gray-600">[STAT_2_LABEL]</div>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <div className="font-bold text-primary text-xl">[STAT_3_VALUE]</div>
                  <div className="text-gray-600">[STAT_3_LABEL]</div>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <div className="font-bold text-primary text-xl">[STAT_4_VALUE]</div>
      ...
      <section className="py-16 bg-white">
        <div className="container-wide">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-blue-100 text-primary hover:bg-blue-200">[OUR_STORY_BADGE]</Badge>
            <h2 className="text-3xl font-bold mb-6">[OUR_STORY_TITLE]</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              [OUR_STORY_DESCRIPTION: A brief overview of your company's journey.]
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-wide">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-blue-100 text-primary hover:bg-blue-200">[OUR_VALUES_BADGE]</Badge>
            <h2 className="text-3xl font-bold mb-6">[OUR_VALUES_TITLE]</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              [OUR_VALUES_DESCRIPTION: Explain why your values matter and how they guide your business.]
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container-wide">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-blue-100 text-primary hover:bg-blue-200">[OUR_TEAM_BADGE]</Badge>
            <h2 className="text-3xl font-bold mb-6">[OUR_TEAM_TITLE]</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              [OUR_TEAM_DESCRIPTION: Introduce your team and their collective expertise.]
            </p>
          </div>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container-wide text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            [JOIN_OUR_TEAM_DESCRIPTION: Encourage potential team members to apply.]
          </p>
