			...
			<div className="container-wide">
				<div className="max-w-4xl mx-auto">
					...
					<div className="prose prose-lg max-w-none">
						...
						<p>
							Paragraph placeholder: introduction explaining who you are and
							purpose of this privacy policy
						</p>

						<h2>2. Information we collect</h2>
						<p>
							Paragraph placeholder: detail types of personal information
							collected from users
						</p>

						<h3>2.1 Personal information</h3>
						<p>
							Paragraph placeholder: specify personal information collected
							(e.g. names, email addresses)
						</p>

						<h3>2.2 Usage data</h3>
						<p>
							Paragraph placeholder: explain usage data collected (e.g. IP
							address, browser type)
						</p>

						<h2>3. How we use your information</h2>
						<p>
							Paragraph placeholder: explain how collected information is used
						</p>
						<ul>
							<li>
								List item placeholder: specific purpose for using collected data
							</li>
							<li>
								List item placeholder: specific purpose for using collected data
							</li>
