...
import { ArrowLeft, Calendar, Clock, Share2, User, ArrowRight } from "lucide-react"
        ...
        <div className="container-wide">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {relatedPosts.map((relatedPost) => (
              <Card key={relatedPost.id} className="overflow-hidden transition-all duration-300 hover:shadow-xl">
