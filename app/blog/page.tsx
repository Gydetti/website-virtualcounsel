      ...
      <section className="bg-gradient-to-r from-blue-50 to-white py-16 md:py-24">
        <div className="container-wide">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-blue-100 text-primary hover:bg-blue-200">Our Blog</Badge>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Latest Insights & Articles</h1>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Expert advice, industry trends, and practical tips to help you grow your business.
            </p>
          </div>
              ...
              <Card className="overflow-hidden border-none shadow-xl">
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="p-6 md:p-8 flex flex-col justify-center">
                    ...
                    <CardDescription className="text-gray-600 mb-6 text-lg">{featuredPost.excerpt}</CardDescription>
        ...
        <div className="container-wide">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {regularPosts.map((post) => (
              <Card key={post.id} className="h-full overflow-hidden transition-all duration-300 hover:shadow-xl">
