...
export const getServices = async (): Promise<Service[]> => {
  ...
  return [
    ...
    },
    {
      ...
      description: "Data-driven marketing strategies that increase your online visibility and drive qualified traffic.",
      icon: "BarChart2",
      features: [
...
export const getBlogPosts = async (limit?: number): Promise<BlogPost[]> => {
  ...
  const posts = [
    ...
    },
    {
      ...
      excerpt: "Discover how automation can streamline your client onboarding and create a better first impression.",
      date: "March 10, 2025",
      category: "Automation",
      image: "/placeholder.svg?height=300&width=600",
    ...
    },
    {
      ...
      excerpt: "Explore proven strategies to establish credibility and build lasting trust with your online audience.",
    ...
    },
    {
      ...
      excerpt: "Understand the real business impact and return on investment from professional web design services.",
