...
export const trackGAEvent = (eventName: string, category: string, label: string, value?: number) => {
...
export const trackEvent = (
  ...
  trackFBEvent(eventName, { content_name: label, value, currency: "EUR", ...additionalParams })
